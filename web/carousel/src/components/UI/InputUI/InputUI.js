      ...
      case "user":
        return (
          <span className={classes.Icon}>
            <UserOutlined className={classes.IconImg} />
          </span>
        );
      case "locked":
        return (
          <span className={classes.Icon}>
            <LockOutlined className={classes.IconImg} />
          </span>
        );
      case "bank":
        return (
          <span className={classes.Icon}>
            <BankOutlined className={classes.IconImg} />
          </span>
        );
      case "email":
        return (
          <span className={classes.Icon}>
            <MailOutlined className={classes.IconImg} />
          </span>
        );
      default:
        return null;
