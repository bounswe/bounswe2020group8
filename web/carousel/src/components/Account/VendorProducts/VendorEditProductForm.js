  ...
  render() {
    ...
    return (
      <Form {...layout} className={classes.myReset} name="nest-messages" onFinish={this.props.clicked}
        ...
        <Form.Item name={['user', 'price']} label="Price" initialValue={this.props.product.price} rules={[{required: true}]}>
          <Input placeholder="price in $"/>
        </Form.Item>
        <Form.Item name={['user', 'amountLeft']} label="Amount" initialValue={this.props.product.amountLeft} rules={[{required: true}]}>
          <Input placeholder="Amount"/>
        </Form.Item>
        <Form.Item name={['user', 'shipmentPrice']} label="Shipment Price" initialValue={this.props.product.shipmentPrice} rules={[{required: true}]}>
          <Input placeholder="Shipment Price in $"/>
        </Form.Item>
        <Form.Item name={['user', 'cargoCompany']} label="Cargo Company" initialValue={this.props.product.cargoCompany} rules={[{required: true}]}>
