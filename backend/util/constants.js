const constants = {
  ...
  OBJECTIVES: {
    ...
    GET_ADMIN_ID: "Get all tickets of an admin.",
    GET_ALL_ADMIN_ID: "Get all active tickets of an admin.",
    GET_CLIENT_ID: "Get all tickets of a client.",
    GET_ALL_CLIENT_ID: "Get all active tickets of a client.",
    GET_ADMIN_ID_CLIENT_ID: "Get all tickets between an admin and a client.",
    GET_ALL_ADMIN_ID_CLIENT_ID: "Get all active tickets between an admin and a client.",
  },
  EVENT_IDS: {
    GET_CATEGORY: 1,
    POST_CATEGORY: 2,
    ...
    GET_ALL_ADMIN_ID: 87,
    GET_CLIENT_ID: 88,
    GET_ALL_CLIENT_ID: 89,
    GET_ADMIN_ID_CLIENT_ID: 90,
    GET_ALL_ADMIN_ID_CLIENT_ID: 91,
  },
  TARGETS: {
    CATEGORY: {
      ONE: "One category.",
