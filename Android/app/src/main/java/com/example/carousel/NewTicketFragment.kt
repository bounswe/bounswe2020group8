...
import com.example.carousel.pojo.PostTicket
import com.example.carousel.pojo.ResponseAllTickets
import com.example.carousel.pojo.ResponseTicket
 ...
 * Use the [NewTicketFragment.newInstance] factory method to
...
class NewTicketFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        add_button.setOnClickListener {
            val apiCallerTickets: ApiCaller<ResponseTicket> = ApiCaller(requireActivity())
            apiCallerTickets.Caller = ApiClient.getClient.createTicket(
                PostTicket(
